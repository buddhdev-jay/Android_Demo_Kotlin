...
class BottomNavigationActivity : AppCompatActivity(),Communicator {
    ...
    private fun swapFragments(fragment: Fragment,message: String? = getString(R.string.hello_nullsafe_string)) {
    ...
    override fun Datapass(data: String) {
        val bundle = Bundle()
        bundle.putString(getString(R.string.key_message_intent),data)
