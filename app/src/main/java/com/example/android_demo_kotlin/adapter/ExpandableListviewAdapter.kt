...
class ExpandableListviewAdapter(
    var context: Context,
    var headerList: MutableList<String>,
    var childList: HashMap<String, List<String>>
) :
    ...
    override fun getGroupView(p0: Int, p1: Boolean, p2: View?, p3: ViewGroup?): View? {
        ...
        p2.let {
            ...
            convertView = inflater.inflate(R.layout.item_listview_header, null)
        }
        val header = convertView?.findViewById<TextView>(R.id.txtview_expand_header)
    ...
    override fun getChildView(p0: Int, p1: Int, p2: Boolean, p3: View?, p4: ViewGroup?): View? {
        ...
        convertView.let {
            val inflater =
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
            convertView = inflater.inflate(R.layout.item_listview_child, null)
        }
        val header = convertView?.findViewById<TextView>(R.id.txtview_expand_child)
