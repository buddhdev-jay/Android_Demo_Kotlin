...
class RecyclerviewApiAdapter(private val context: Context, private val usersList: ArrayList<PersonList>, private val itemClickCallBack: (Any) -> Unit) : RecyclerView.Adapter<RecyclerviewApiAdapter.ViewHolder>() {
            ...
            GlobalScope.launch(Dispatchers.IO) {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    with(usersList[position]){
                        firstNameOfUser.text = firstName
                        lastNameOfUser.text = lastName
