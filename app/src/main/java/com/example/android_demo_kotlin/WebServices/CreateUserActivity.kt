...
class CreateUserActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_create_user.setOnClickListener {
            when {
                TextUtils.isEmpty(editxt_createuser_name.text.toString()) -> {
                    Toast.makeText(this, getString(R.string.enter_name_toast), Toast.LENGTH_SHORT)
                        .show()
                }
                TextUtils.isEmpty(editxt_createuser_job.text.toString()) -> {
                    Toast.makeText(this, getString(R.string.enter_job_toast), Toast.LENGTH_SHORT)
                        .show()
                }
                else -> {
