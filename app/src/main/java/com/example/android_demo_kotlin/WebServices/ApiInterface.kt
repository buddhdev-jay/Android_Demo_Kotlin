...
import com.example.android_demo_kotlin.utils.ADD_USER_API_LINK
...
import com.example.android_demo_kotlin.utils.GET_USER_API_LINK
        ...
        private val okHttpClientBuilder = OkHttpClient.Builder().addInterceptor(interceptor)
            .addInterceptor(
                Interceptor {
                    ...
                    builder.header(APPLICATION_DATA_TYPE, APPICATION_ACCEPT)
